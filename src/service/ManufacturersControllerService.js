...
exports.createManufacturer = function(body) {
  return new Promise(function(resolve, reject) {
    console.log(body);
    sql.query("INSERT INTO manufacturer (name, founded, description) values (?,?,?)", [body.name, body.founded, body.description], function (err, res) {
      if (err) {
        console.log(err);
        reject(err);
      }else{
...
exports.updateManufacturer = function(body,id) {
  return new Promise(function(resolve, reject) {
    sql.query("UPDATE manufacturer SET name = ?, founded = ?, description = ? WHERE id = ?", [body.name, body.founded, body.description, id], function (err, res) {
      if (err) {
        console.log(err);
        reject(err);
      } else {
